...
MOTION_ORIENTIERUNG = {
  :ident => "Finanzantrag/Orientierungsveranstaltung", # rename in Kingslanding, too
  :groups => [
...
MOTION_REISEKOSTEN = {
  :ident => "Finanzantrag/Reisekostenantrag", # rename in Kingslanding, too
  :groups => [
...
MOTION_VORTRAG = {
  :ident => "Finanzantrag/Vortrag (Honorar)", # rename in Kingslanding, too
  :groups => [
    { :group => "zur Veranstaltung", :summary => "Veranstaltungsdetails", :fields => [
      { :name => "Veranstalter", :placeholder => "z.B. Fachschaft", :autocomplete => :Fachschaft, :type => :string },
      { :name => "Ort", :type => :string },
